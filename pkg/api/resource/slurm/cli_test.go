...
func TestParseSacctCmdOutput(t *testing.T) {
	...
	if units[0].TotalTime["walltime"] != 3600 {
		t.Errorf("expected walltime 3600, got %f", units[0].TotalTime["walltime"])
	}
	...
	// Check if elapsed time corresponds to real elapsed time of job
	if units[0].TotalTime["walltime"] != 0 {
		t.Errorf("expected walltime 0, got %f", units[0].TotalTime["walltime"])
	}
	...
	// Check if elapsed time corresponds to real elapsed time of job
	if units[0].TotalTime["walltime"] != 300 {
		t.Errorf("expected walltime 300, got %f", units[0].TotalTime["walltime"])
	}
	...
	// Check if elapsed time corresponds to real elapsed time of job
	if units[0].TotalTime["walltime"] != 600 {
		t.Errorf("expected walltime 600, got %f", units[0].TotalTime["walltime"])
	}
	...
	// Check if elapsed time corresponds to real elapsed time of job
	if units[0].TotalTime["walltime"] != 120 {
		t.Errorf("expected walltime 120, got %f", units[0].TotalTime["walltime"])
	}
}
