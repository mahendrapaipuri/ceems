...
var (
	...
	sacctCmdOutput = `1479763|part1|qos1|acc1|grp|1000|usr|1000|2023-02-21T14:37:02+0100|2023-02-21T14:37:07+0100|NA|01:49:22|3000|0:0|RUNNING|billing=80,cpu=160,energy=1439089,gres/gpu=8,mem=320G,node=2|compute-0|test_script1|/home/usr
	...
	expectedBatchJobs = []models.Unit{
		...
		},
		{
			...
			TotalTime: models.MetricMap{
				...
				"alloc_gpumemtime": models.JSONFloat(623),
			},
			State: "COMPLETED",
			Allocation: models.Generic{
				"cpus":    int64(2),
